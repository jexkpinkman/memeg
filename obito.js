...
class ObitoScene {
    ...
    init() {
        ...
        console.log('Obito 3D Scene initialized');
    }
    ...
    createObitoParticles() {
        ...
        for (let i = 0; i < particleCount; i++) {
            ...
            if (colorType < 0.5) {
                colors.push(0.9, 0.1, 0.05);
            } else if (colorType < 0.8) {
                colors.push(0.9, 0.4, 0.05);
            } else {
                colors.push(0.1, 0.05, 0.05);
            }
        }
    ...
    animate() {
        ...
        if (this.sharingan) {
            ...
            this.sharingan.children.forEach((child) => {
        ...
        if (this.spiralRings) {
            this.spiralRings.children.forEach((ring) => {
...
// Initialize - check if DOM already loaded
function initObito() {
...
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', initObito);
} else {
    initObito();
}

// Toggle Kamui effect
function toggleKamui() {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (toggleBtn) {
        toggleBtn.addEventListener('click', toggleKamui);
    }
});